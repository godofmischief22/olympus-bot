...
class HelpCommand(commands.HelpCommand):
  ...
  if isinstance(cmd, app_commands.Command)
    ...
    embed.add_field(name="**Use the Buttons, to swap Pages & Menu to select Help pages.Need help?**[Support](https://discord.gg/6xyJzcMXRA).**")
    embed.set_footer(
