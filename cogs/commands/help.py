...
class HelpCommand(commands.HelpCommand):
  ...
  if isinstance(cmd, app_commands.Command)
    ...
    embed.add_field(name="馃摐 __**General Info:**__", value= f"<:prefix:1368486105275564083> Server Prefix:  **{prefix}** \n馃敶 Total Commands: **{len(set(self.context.bot.walk_commands()))}**\n馃敶 Total Slash Commands: **{slash}**\n馃敶 **[Get Sentinel](https://discord.com/oauth2/authorize?client_id=1144179659735572640&permissions=2113268958&scope=bot)** | **[Support](https://discord.com/invite/odx)**\n\n鉂� __**How do you use me?**__\n>>> `{prefix}help <command/module>` to get more info regarding that command/module\nFor example: `{prefix}help antinuke`\n\n")

    embed.add_field(name="猸� __**My Features**__", value=">>> **50+ Systems, including:**\n 馃洝锔� Security\n 馃毃 Automoderation\n 馃敡 Utility\n 馃幍 Music\n 馃洜锔� Moderation\n 馃З Customrole\n 馃帀 Giveaway\n 馃帣锔� Voice\n 馃幃 Games\n 馃憢 Welcomer\n 馃 Autoreact & responder\n 馃搵 Autorole & Invc\n 馃幁 Fun & AI Image Gen\n   And much more!...")
