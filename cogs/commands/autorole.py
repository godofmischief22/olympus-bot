...
class AutoRole(commands.Cog):
    ...
    async def _ar_config(self, ctx):
        ...
        if data:
            ...
            emb.add_field(name="<:olympus_friend:1368430235871084554> __Humans__", value=hums, inline=False)
            emb.add_field(name="<:olympus_bot:1368430421972484227> __Bots__", value=bos, inline=False)
